...
const createPlaneCard = (plane) => {
  const domString = ` <div id="${plane.id}" class="plane-card">
                        ...
                        <button class="plane-button btn btn-light delete-plane">
                        <i class="fas fa-trash" style="color:#2767AD;"></i>  Crash</button>
                        <button class="plane-button btn btn-light edit-plane">
                        <i class="far fa-edit" style="color:#2767AD;"></i>  Edit</button>
                      </div> `;
  return domString;
};
